...
<details>
<summary>**wikipedia_100k dataset**, adaparse can parse URLs **three times faster than trurl**.</summary>
```bash
...
<details>
<summary>Using **top100 dataset**, adaparse is **twice as fast as the trurl**.</summary>
```bash
