...
<Aside>Ada is available on different programming languages such as **C++**, **Python**, **Go**, **Rust** or **LuaJIT**.</Aside>
...
<Aside>Ada uses **cmake** as a build system. It's recommended to have cmake available in your system.</Aside>
...
<Steps>
 ...
 1. Build and prepare the docker file
